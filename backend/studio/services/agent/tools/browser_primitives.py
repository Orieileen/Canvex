...
# --- DSL field coercion (robot_authoring's step drafting) --------------------------------
# One home for these so authoring persists ms/count values that already satisfy the bounds
# the extension executor enforces at run time. Kept in exact lockstep with the extension's
# clampMs / clampCount (extension/background.js).
