 ...
 * WHY (the agent's reasoning), this shows WHAT (the page): a read-only screenshot pane that
 * paints the latest frame the `browse` / `web_operator` tool streams as the agent drives.
 */
