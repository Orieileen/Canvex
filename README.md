<div align="center">
  <h1>Canvex</h1>
  <p>Canvex 是一个具有对话、skills、生成和编辑图像和视频能力的无限画布 LLM Agent。这是一款专门为电商卖家/美工做的工具。通过场景管理，可以将多个画布用于不同的项目。</p>
  <p>
...
3. **视角重渲染** —— 先去 **[fal.ai](https://fal.ai/)** 注册拿到 API key，用于「换视角」（改变机位）功能。用的模型是 `fal-ai/qwen-image-edit-2511-multiple-angles`。
