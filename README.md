...
- **Bilingual UI** — an English / 中文 toggle at the bottom of the sidebar (it switches Excalidraw's own locale too), next to an illustrated Help dialog. A minimap, a live W×H readout and a "back to latest" jump round out the canvas tools.
